...
public class UiQueue {
    ...
    public final void unsubscribe(final Handler handler) {
        ...
        if (handler != mHandler) {
            Log.w(BaseApplication.LOG_TAG, "ServiceQueue.unsubscribe() "
    ...
    public final void postToUi(final Type type, final Bundle bundle,
        ...
        if (mHandler != null) {
            ...
            /** Suppress update. **/
            Log.w(BaseApplication.LOG_TAG, "UiQueue.postToUi() Suppressing "
            ...
            synchronized (mQueueLock) {
                ...
                if (queue == null || message.what < queue.what) {
                    ...
                    Log.w(BaseApplication.LOG_TAG, "UiQueue.postToUi() "
